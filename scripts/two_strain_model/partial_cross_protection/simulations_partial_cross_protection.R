...
source('./scripts/two_strain_model/partial_cross_protection/sim_table_config.R')
...
#save the simulation
saveRDS(object = orv_npi_all_scenarios_dynamics, file = './model_output/model_summaries_partial_cross_protection.rds')
