...
npi_start <- 1
npi_duration <- max_time - npi_start
npi_intensity <- seq(0, 0.5, by = 0.02) #Five levels of npi intensity (could correspond to the five stages in South Africa, for e.g)
...
vax_escape_sim_config_table <- campaign_controls_scenarios_df %>%
