    ...
    res <- sim_table %>% 
        ...
        do({with(.,
                 simulate_raw_dynamics(model_func = two_strain_model, 
                                       get_summaries_func = extract_model_summaries,
                                       pop_inits = pop_inits, 
...
#save the simulation
saveRDS(object = orv_npi_all_scenarios_dynamics_final, file = './model_output/sensitivity_analyses/variant_R0/model_summaries_R0m_60_percent_partial_cross_protection.rds')
