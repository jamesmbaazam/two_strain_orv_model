...
efficacy_loss_sensitivity_simulation_table <- bind_cols(
  intervention_params_expanded,
  dynamics_params_expanded
) %>%
...
# save the simulation
saveRDS(object = efficacy_loss_sensitivity_analysis_summaries, 
        file = "./model_output/sensitivity_analyses/efficacy_loss/efficacy_loss_sensitivity_analysis_summaries.rds"
        )
